...
export default function NewGame(props) {
    ...
    const newGameHandler = e => {
        ...
        const newGameObj = {
            ...
            */
            ...
            stats: {
                ...
                ghostSession: {sessionID: Number}, // Used to check logins with no actions
        ...
        // Add TimeStamp to NewGame -  ghostSession && lastTimeStamp
        newGameObj.stats.ghostSession.sessionID = newGameObj.stats.lastTimeStamp = getTimeStampNow();
